export const personalInfo = {
  ...
  bio: 'M.Sc. AI student at OTH Amberg-Weiden with 2+ years of professional software engineering experience. Passionate about AI, machine learning, data engineering, and building intelligent systems.',
};
...
export const education = [
  {
    ...
    courses: [
      ...
      { name: 'Machine Learning', grade: null, label: 'passed' },
    ],
  },
  {
...
export const projects = [
  {
    ...
    period: '2025 – present',
    stack: ['Python', 'FastAPI', 'SQLAlchemy', 'pandas', 'Streamlit', 'Docker', 'GitHub Actions'],
    bullets: [
  ...
  },
  {
    ...
    period: '2024 – 2025',
    stack: ['Python', 'Transformers', 'FAISS', 'scikit-learn', 'spaCy', 'pandas'],
    bullets: [
...
export const skills = {
  Programming: ['Python', 'pandas', 'NumPy', 'scikit-learn', 'PyTorch', 'FastAPI', 'SQL', 'Java', 'JavaScript', 'Bash', 'C (basics)'],
  'ML & AI': ['scikit-learn', 'PyTorch', 'YOLOv8', 'HuggingFace Transformers', 'FAISS', 'spaCy', 'OpenCV'],
  'Data & Cloud': ['ETL Pipelines', 'SQLAlchemy', 'Docker', 'GitHub Actions', 'Azure', 'Snowflake', 'Railway', 'Fly.io'],
  Visualization: ['Streamlit', 'Plotly', 'pandas visualization'],
  Tools: ['Git', 'GitHub Actions', 'pytest', 'flake8', 'Docker', 'Linux', 'MQTT'],
};

export const languages = [
  { lang: 'English', level: 'C1', desc: 'Fluent' },
  { lang: 'German', level: 'A2', desc: 'Learning (target B1 by 2026)' },
  { lang: 'Hindi', level: 'Native', desc: 'Native' },
  { lang: 'Gujarati', level: 'Native', desc: 'Native' },
];
